...
#include <memory>
#include "../OSsimulator-master/clock.h"
...
QT_MOC_LITERAL(1, 6, 9), // "ClockTick"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 11), // "MyTimerSlot"
QT_MOC_LITERAL(4, 29, 5) // "start"

    },
    "Clock\0ClockTick\0\0MyTimerSlot\0start"
};
...
void Clock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ClockTick((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Clock::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Clock::ClockTick)) {
                *result = 0;
                return;
            }
        }
